...
//  ---------------------------------------------------------------------
        ...
        if (team1Runs > team2Runs) {
            ...
            if (firstInningsTeam
                    .equals(match.getTeam2().getId())) {       //won by runs
                result =
                        teamWinner + " won by " + (
...
//   -------------------------------------------------------------------------
        ...
        double preNetRunRateTeam1 = (
                preRunRate1 - preRunRate2) - pointTableTeam1
                .getNetRunRate();
        pointTableTeam1
                .setNetRunRate(Double.valueOf(DF
                        .format(preNetRunRateTeam1)));
        double preNetRunRateTeam2 = (
                preRunRate2 - preRunRate1) - pointTableTeam2
                .getNetRunRate();
        pointTableTeam2
                .setNetRunRate(Double.valueOf(DF
                .format(preNetRunRateTeam2)));
        double netRunRateTeam1 = (
                runRate1 - runRate2) + pointTableTeam1
                .getNetRunRate() - preNetRunRateTeam1;
        pointTableTeam1.setNetRunRate(
                Double.valueOf(DF.format(netRunRateTeam1)));
        double netRunRateTeam2 = (
                runRate2 - runRate1) + pointTableTeam2
                .getNetRunRate() - preNetRunRateTeam2;
        pointTableTeam2.setNetRunRate(
                Double.valueOf(DF.format(netRunRateTeam2)));
