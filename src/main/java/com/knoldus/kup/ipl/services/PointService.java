...
public class PointService {
     ...
     * @param match
     */
    public void addPointTable(final Match match) {
        ...
        double netRunRateTeam1 =
                (runRate1 - runRate2) + pointTableTeam1.getNetRunRate();
        pointTableTeam1.setNetRunRate(Double
                .valueOf(DF.format(netRunRateTeam1)));

        double netRunRateTeam2 =
                (runRate2 - runRate1) + pointTableTeam2.getNetRunRate();
        pointTableTeam2.setNetRunRate(Double
                .valueOf(DF.format(netRunRateTeam2)));
    ...
    /**
     * @param id
     * @return Point Table by Id  .
     */
    public PointTable getById(final Long id) {
